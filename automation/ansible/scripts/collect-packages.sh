...
REMOTE_PROJECT_DIR="/opt/simple-rsyncd"
...
- name: Collect packages from remote VMs
  ...
  vars:
    ...
    remote_dist_dir: "/opt/simple-rsyncd/dist"
    remote_build_dir: "/opt/simple-rsyncd/build"
    remote_centralized_dir: "/opt/simple-rsyncd/dist/centralized/v$VERSION"
